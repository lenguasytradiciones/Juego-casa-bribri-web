...
const visualObjects = [
    {
        ...
        position: Platform.OS === 'web' ? { x: wp('4%'), y: hp('51%') } : getResponsivePos(-1, 103),
        size: {
    ...
    },
    {
        ...
        position: Platform.OS === 'web' ? { x: wp('28%'), y: hp('52%') } : getResponsivePos(56, 103),
        size: {
    ...
    },
    {
        ...
        position: Platform.OS === 'web' ? { x: wp('58.3%'), y: hp('20%') } : getResponsivePos(123, 40),
        size: {
    ...
    },
    {
        ...
        position: Platform.OS === 'web' ? { x: wp('19%'), y: hp('58%') } : getResponsivePos(33, 115),
        size: {
