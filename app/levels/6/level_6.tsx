...
const visualObjects = [
  {
    ...
    position: Platform.OS === 'web' ? { x: wp('11.7%'), y: hp('0%') } : getResponsivePos(16, 1),
    size: {
  ...
  },
  {
    ...
    position: Platform.OS === 'web' ? { x: wp('53%'), y: hp('24%') } : getResponsivePos(115, 50),
    size: {
  ...
  },
  {
    ...
    position: Platform.OS === 'web' ? { x: wp('5%'), y: hp('5.5%') } : getResponsivePos(1, 10),
    size: {
  ...
  },
  {
    ...
    position: Platform.OS === 'web' ? { x: wp('54%'), y: hp('1%') } : getResponsivePos(115.5, 1),
    size: {
      normal: { width: wp('21%'), height: hp('28%') },
      selected: { width: wp('21%'), height: hp('28%') },
    },
